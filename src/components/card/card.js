	...
	render() {
		...
		this.el.innerHTML = `
		   <div class="card__image">
		       <img src="https://covers.openlibrary.org/b/olid/${this.cardState.cover_edition_key}-M.jpg" alt="Обложка ${this.cardState.cover_edition_key}" />
		   </div>
		   <div class="card__info">
			   ...
			   <div class="card__footer">
			       <button class="button__add ${existInFavorites ? 'button__active' : ''} ">
				      <img src="/static/favorite.png" alt="favorite icon" />		
				   </button>
			   </div> 
		   </div>
		`;
